...
- Your task is to generate the instructions files that contain information describing how a coding agent seeing it for the first time can work most efficiently.
...
- While performaing this task if there are any ambiguous decisions you need to make, please pause to ask me for input before completing the task.
...
- Socket.io for real-time updates and keeping front-end state in-sync.
